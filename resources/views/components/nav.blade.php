<nav class="bg-white py-4 relative z-[1000]">
    <div class="max-w-[1200px] mx-auto px-5 md:px-6 flex justify-between items-center">
        <a class="h-full flex justify-center items-center" href="/">
        ...
        <ul id="mobileNav"
            ...
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
                <a href="/about"
                    class="no-underline text-gray-800 font-medium px-3 py-2 transition-colors duration-300 hover:text-orange-500 whitespace-nowrap">
                    Về Vato
                </a>
            </li>
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
            ...
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
                <a href="/register"
                    class="inline-block border border-gray-300 rounded-md px-5 py-2 cursor-pointer transition-all duration-300
                          text-gray-600 hover:text-orange-500 hover:border-orange-500 bg-white">
                    Đăng ký
                </a>
            </li>
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
                <a href="/login"
                    class="inline-block border border-gray-900 rounded-md px-5 py-2 cursor-pointer transition-all duration-300
                          bg-gray-900 text-white hover:bg-white hover:text-orange-500 hover:border-orange-500">
                    Đăng nhập
                </a>
            </li>
            @endguest
            @auth
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
                <span class="font-medium text-[#333]">{{ auth()->user()->name }}</span>
            </li>
            <li class="md:ml-6 my-2 md:my-0 text-center w-full md:w-auto">
                <form method="POST" action="/logout">
                    @csrf
                    <button type="submit" class="inline-block border border-gray-300 rounded-md px-5 py-2 cursor-pointer transition-all duration-300 text-gray-600 hover:text-orange-500 hover:border-orange-500 bg-white">Đăng xuất</button>
                </form>
            </li>
            @endauth
        </ul>
