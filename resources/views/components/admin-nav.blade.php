<aside class="fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white flex flex-col">
    <div class="px-4 py-4 border-b border-gray-800 flex items-center space-x-2">
        ...
        <a href="{{ url('/admin') }}" class="text-lg font-bold">Vato Admin</a>
    </div>
    <nav class="flex-1 px-2 py-3 space-y-1">
        <a href="{{ url('/admin') }}" class="flex items-center space-x-2 px-3 py-2 rounded hover:bg-gray-800">
        ...
        <a href="{{ url('/admin/cars') }}" class="flex items-center space-x-2 px-3 py-2 rounded hover:bg-gray-800">
        ...
        <a href="{{ url('/admin/bookings') }}" class="flex items-center space-x-2 px-3 py-2 rounded hover:bg-gray-800">
