...
<body class="bg-[#f5f7fb] overflow-x-hidden">
    ...
    <section class="ml-64 w-[calc(100vw-16rem)] max-w-[calc(100vw-16rem)] px-6 lg:px-8 py-10">
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Chủ xe</h1>
            ...
            <table class="min-w-full table-fixed">
                <thead class="bg-green-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left">Số xe</th>
                ...
                <tbody>
                    ...
                    <tr class="border-t hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-2">{{ $owner->cars_count }}</td>
                        <td class="px-4 py-2">
                            <form method="POST" action="{{ url('/admin/users/' . $owner->id . '/lock') }}" class="inline" onsubmit="return confirm('Xóa chủ xe này? Hành động không thể hoàn tác.');">
                                @csrf
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-gray-600">Chưa có chủ xe</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
